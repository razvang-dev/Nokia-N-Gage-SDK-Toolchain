...
function(build_resource source_dir basename extra_args)
  ...
  add_custom_target(
    ...
    COMMAND
    ${EPOC_PLATFORM}/Tools/rcomp -6 -u -s${CMAKE_CURRENT_BINARY_DIR}/${basename}.RSS_Intermediate -h${CMAKE_CURRENT_BINARY_DIR}/${basename}.rsg -o${CMAKE_CURRENT_BINARY_DIR}/${basename}.rsc)
endfunction()

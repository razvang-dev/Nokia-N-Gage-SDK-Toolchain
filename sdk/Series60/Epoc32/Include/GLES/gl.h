 ...
 *
 * The most up-to-date version of the OpenGL ES specification
 * can be found from http://www.khronos.org/opengles/spec.html
 *
 * $Id: //hybrid/products/gerbera/3.0/api_opengl/interface/GLES/gl.h#2 $
 * $Date: 2006/05/23 $
 * $Author: sampo $ *
 *
 *//**
...
#define GERBERA_VERSION_MAJOR		3
#define GERBERA_VERSION_MINOR		0
#define GERBERA_VERSION_REVISION	1

/*-------------------------------------------------------------------------
 * Check Gerbera's ES version. Must be either 100 (ES 1.0) or 110 (ES 1.1).
 *
 * \note DON'T TOUCH UNLESS YOU'RE COMPILING THE GERBERA SOURCE RELEASE
 * AND YOU KNOW WHAT YOU ARE DOING!!!
 *-----------------------------------------------------------------------*/

#if !defined(GERBERA_ES_VERSION)
#	define GERBERA_ES_VERSION 110
#elif (GERBERA_ES_VERSION != 100 && GERBERA_ES_VERSION != 110)
#	error Invalid GERBERA_ES_VERSION! Must be either 100 or 110.
#endif
...
#if (GERBERA_ES_VERSION >= 110)
	typedef long int		GLintptr;
	typedef long int		GLsizeiptr;
#endif /* GERBERA_ES_VERSION >= 110 */

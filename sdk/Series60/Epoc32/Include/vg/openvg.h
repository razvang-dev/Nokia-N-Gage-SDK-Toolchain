 ...
 * -------------------------------
 *
 * (C) 2005 Khronos Group -- original code (OpenVG Specification Ratification Draft)
 ...
 *
 * $Id: //hybrid/products/openvg/1.3/openvg/include/vg/openvg.h#2 $
 * $Date: 2006/05/23 $
 * $Author: sampo $ *
 *
 *//**
 * \file
 * \brief   Public OpenVG API
 *//*-------------------------------------------------------------------*/
...
typedef enum {
  VG_MOVE_TO_ABS                              = VG_MOVE_TO    | (VGPathSegment)VG_ABSOLUTE,
  VG_MOVE_TO_REL                              = VG_MOVE_TO    | (VGPathSegment)VG_RELATIVE,
  VG_LINE_TO_ABS                              = VG_LINE_TO    | (VGPathSegment)VG_ABSOLUTE,
  VG_LINE_TO_REL                              = VG_LINE_TO    | (VGPathSegment)VG_RELATIVE,
  VG_HLINE_TO_ABS                             = VG_HLINE_TO   | (VGPathSegment)VG_ABSOLUTE,
  VG_HLINE_TO_REL                             = VG_HLINE_TO   | (VGPathSegment)VG_RELATIVE,
  VG_VLINE_TO_ABS                             = VG_VLINE_TO   | (VGPathSegment)VG_ABSOLUTE,
  VG_VLINE_TO_REL                             = VG_VLINE_TO   | (VGPathSegment)VG_RELATIVE,
  VG_QUAD_TO_ABS                              = VG_QUAD_TO    | (VGPathSegment)VG_ABSOLUTE,
  VG_QUAD_TO_REL                              = VG_QUAD_TO    | (VGPathSegment)VG_RELATIVE,
  VG_CUBIC_TO_ABS                             = VG_CUBIC_TO   | (VGPathSegment)VG_ABSOLUTE,
  VG_CUBIC_TO_REL                             = VG_CUBIC_TO   | (VGPathSegment)VG_RELATIVE,
  VG_SQUAD_TO_ABS                             = VG_SQUAD_TO   | (VGPathSegment)VG_ABSOLUTE,
  VG_SQUAD_TO_REL                             = VG_SQUAD_TO   | (VGPathSegment)VG_RELATIVE,
  VG_SCUBIC_TO_ABS                            = VG_SCUBIC_TO  | (VGPathSegment)VG_ABSOLUTE,
  VG_SCUBIC_TO_REL                            = VG_SCUBIC_TO  | (VGPathSegment)VG_RELATIVE,
  VG_SCCWARC_TO_ABS                           = VG_SCCWARC_TO | (VGPathSegment)VG_ABSOLUTE,
  VG_SCCWARC_TO_REL                           = VG_SCCWARC_TO | (VGPathSegment)VG_RELATIVE,
  VG_SCWARC_TO_ABS                            = VG_SCWARC_TO  | (VGPathSegment)VG_ABSOLUTE,
  VG_SCWARC_TO_REL                            = VG_SCWARC_TO  | (VGPathSegment)VG_RELATIVE,
  VG_LCCWARC_TO_ABS                           = VG_LCCWARC_TO | (VGPathSegment)VG_ABSOLUTE,
  VG_LCCWARC_TO_REL                           = VG_LCCWARC_TO | (VGPathSegment)VG_RELATIVE,
  VG_LCWARC_TO_ABS                            = VG_LCWARC_TO  | (VGPathSegment)VG_ABSOLUTE,
  VG_LCWARC_TO_REL                            = VG_LCWARC_TO  | (VGPathSegment)VG_RELATIVE
} VGPathCommand;
...
typedef enum {
  ...
  /* Hybrid's extension formats */
  VG_sXRGB_8888_HG                            = 13,
  VG_sARGB_8888_HG                            = 14,
  VG_sARGB_8888_PRE_HG                        = 15,
  VG_sARGB_1555_HG                            = 16,
  VG_sARGB_4444_HG                            = 17,
  VG_lXRGB_8888_HG                            = 18,
  VG_lARGB_8888_HG                            = 19,
  VG_lARGB_8888_PRE_HG                        = 20,
  VG_IMAGE_FORMAT_MAX_HG                      = 21      /* end of enumeration */
} VGImageFormat;
...
/* Exported functions that pass or return floats by value define this macro */
#ifndef VG_FP_CALL
#   if defined (__SYMBIAN32__) && defined (__ARMCC_2__)
#       define VG_FP_CALL __softfp
#   else
#       define VG_FP_CALL
#   endif
#endif
...
/* Getters and Setters */
VG_API_CALL void vgSetf (VGParamType type, VGfloat value) VG_FP_CALL;
...
VG_API_CALL VGfloat vgGetf(VGParamType type) VG_FP_CALL;
...
VG_API_CALL void vgTranslate(VGfloat tx, VGfloat ty) VG_FP_CALL;
VG_API_CALL void vgScale(VGfloat sx, VGfloat sy) VG_FP_CALL;
VG_API_CALL void vgShear(VGfloat shx, VGfloat shy) VG_FP_CALL;
VG_API_CALL void vgRotate(VGfloat angle) VG_FP_CALL;
...
VG_API_CALL VGPath vgCreatePath(VGint pathFormat,
                                ...
                                VGbitfield capabilities) VG_FP_CALL;
...
VG_API_CALL VGboolean vgInterpolatePath(VGPath dstPath,
                                        VGPath startPath,
                                        VGPath endPath,
                                        VGfloat amount) VG_FP_CALL;
VG_API_CALL VGfloat vgPathLength(VGPath path,
                                 VGint startSegment, VGint numSegments) VG_FP_CALL;
VG_API_CALL void vgPointAlongPath(VGPath path,
                                  VGint startSegment, VGint numSegments,
                                  VGfloat distance,
                                  VGfloat * x, VGfloat * y,
                                  VGfloat * tangentX, VGfloat * tangentY) VG_FP_CALL;
...
VG_API_CALL void vgConvolve(VGImage dst, VGImage src,
                            ...
                            VGfloat scale,
                            VGfloat bias,
                            VGTilingMode tilingMode) VG_FP_CALL;
...
#define OVG_HG_ARGB_IMAGE_FORMATS 1

#define OVG_HG_GET_CONFIG 1
VG_API_CALL const VGubyte* vgGetCompileTimeConfigHG(void);
VG_API_CALL const VGubyte* vgGetRunTimeConfigHG(void);


#ifdef HG_DEVEL
#define OVG_HG_SETCPIXELPIPE    1

/* In the development build, this forces the use of c pixel pipe. VG_FALSE by default. */
VG_API_CALL void vgSetCPixelPipeHG(VGboolean useCPixelPipe);

#endif /* HG_DEVEL */


#if defined(HG_DEVEL) && defined(OVG_DUMP_STATISTICS)
#define OVG_HG_STATISTICS       1

/* In the statistics build, this resets statistics counters. */
VG_API_CALL void vgResetStatisticsHG(void);

/* In the statistics build, this returns statistics gathered since the last vgResetStatisticsHG.
   Legal statistics names include:
    HGnumSubdivisionOps
    HGnumSubdivisionOpsViewportCulled
    HGnumFillEdgesSubmitted
    HGnumStrokeEdgesSubmitted
    HGnumRasterizerPolygonsSubmitted
    HGnumRasterizerPolygonsDrawn
    HGnumRasterizerEdgesSubmitted
    HGnumRasterizerEdgesDrawn
    HGnumRasterizerEdgesFloatProcessed
    HGnumRasterizerDuplicateEdgesRemoved
    HGnumRasterizerScanlines
    HGnumRasterizerScanlinesCulled
    HGnumRasterizerEdgeUpdates
    HGnumRasterizerEventPixels
    HGnumRasterizerPixelEvents
    HGnumRasterizerOutputSpans
    HGnumRasterizerOpaquePixels
    HGnumRasterizerTransparentPixels
    HGnumRasterizerCulledPixels
    HGnumStitchedLoops
    HGnumCodeCacheDefrags
*/
VG_API_CALL VGint   vgGetStatisticiHG(const VGubyte* string);

#endif /* HG_DEVEL && OVG_DUMP_STATISTICS */

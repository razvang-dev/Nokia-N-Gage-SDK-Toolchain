...
#define MASK_NOP_FUN_DLLIMPORT (1 << 11)
...
#define TARGET_NOP_FUN_DLLIMPORT ((target_flags & MASK_NOP_FUN_DLLIMPORT) != 0)
...
enum opt_code
{
  ...
  OPT_mabi_ = 753,                           /* -mabi= */
  OPT_mabort_on_noreturn = 754,              /* -mabort-on-noreturn */
  OPT_mapcs = 755,                           /* -mapcs */
  OPT_mapcs_float = 756,                     /* -mapcs-float */
  OPT_mapcs_frame = 757,                     /* -mapcs-frame */
  OPT_mapcs_reentrant = 758,                 /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 759,               /* -mapcs-stack-check */
  OPT_march_ = 760,                          /* -march= */
  OPT_marm = 761,                            /* -marm */
  OPT_mbig_endian = 762,                     /* -mbig-endian */
  OPT_mcallee_super_interworking = 763,      /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 764,      /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 765,       /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 766,                           /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 767,             /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 768,                     /* -mfloat-abi= */
  OPT_mfp16_format_ = 769,                   /* -mfp16-format= */
  OPT_mfp_ = 770,                            /* -mfp= */
  OPT_mfpe = 771,                            /* -mfpe */
  OPT_mfpe_ = 772,                           /* -mfpe= */
  OPT_mfpu_ = 773,                           /* -mfpu= */
  OPT_mhard_float = 774,                     /* -mhard-float */
  OPT_mlittle_endian = 775,                  /* -mlittle-endian */
  OPT_mlong_calls = 776,                     /* -mlong-calls */
  OPT_mnop_fun_dllimport = 777,              /* -mnop-fun-dllimport */
  OPT_mpic_register_ = 778,                  /* -mpic-register= */
  OPT_mpoke_function_name = 779,             /* -mpoke-function-name */
  OPT_msched_prolog = 780,                   /* -msched-prolog */
  OPT_msingle_pic_base = 781,                /* -msingle-pic-base */
  OPT_msoft_float = 782,                     /* -msoft-float */
  OPT_mstructure_size_boundary_ = 783,       /* -mstructure-size-boundary= */
  OPT_mthumb = 784,                          /* -mthumb */
  OPT_mthumb_interwork = 785,                /* -mthumb-interwork */
  OPT_mtp_ = 786,                            /* -mtp= */
  OPT_mtpcs_frame = 787,                     /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 788,                /* -mtpcs-leaf-frame */
  OPT_mtune_ = 789,                          /* -mtune= */
  OPT_mvectorize_with_neon_quad = 790,       /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 791,               /* -mword-relocations */
  OPT_mwords_little_endian = 792,            /* -mwords-little-endian */
  OPT_n = 793,                               /* -n */
  OPT_no_canonical_prefixes = 794,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 795,               /* -no-integrated-cpp */
  OPT_nodefaultlibs = 796,                   /* -nodefaultlibs */
  OPT_nostartfiles = 797,                    /* -nostartfiles */
  OPT_nostdinc = 798,                        /* -nostdinc */
  OPT_nostdinc__ = 799,                      /* -nostdinc++ */
  OPT_nostdlib = 800,                        /* -nostdlib */
  OPT_o = 801,                               /* -o */
  OPT_p = 802,                               /* -p */
  OPT_pass_exit_codes = 803,                 /* -pass-exit-codes */
  OPT_pedantic = 804,                        /* -pedantic */
  OPT_pedantic_errors = 805,                 /* -pedantic-errors */
  OPT_pg = 806,                              /* -pg */
  OPT_pie = 807,                             /* -pie */
  OPT_pipe = 808,                            /* -pipe */
  OPT_print_file_name_ = 809,                /* -print-file-name= */
  OPT_print_libgcc_file_name = 810,          /* -print-libgcc-file-name */
  OPT_print_multi_directory = 811,           /* -print-multi-directory */
  OPT_print_multi_lib = 812,                 /* -print-multi-lib */
  OPT_print_multi_os_directory = 813,        /* -print-multi-os-directory */
  OPT_print_multiarch = 814,                 /* -print-multiarch */
  OPT_print_objc_runtime_info = 815,         /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 816,                /* -print-prog-name= */
  OPT_print_search_dirs = 817,               /* -print-search-dirs */
  OPT_print_sysroot = 818,                   /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 819,    /* -print-sysroot-headers-suffix */
  OPT_quiet = 820,                           /* -quiet */
  OPT_r = 821,                               /* -r */
  OPT_remap = 822,                           /* -remap */
  OPT_s = 823,                               /* -s */
  OPT_save_temps = 824,                      /* -save-temps */
  OPT_save_temps_ = 825,                     /* -save-temps= */
  OPT_shared = 826,                          /* -shared */
  OPT_shared_libgcc = 827,                   /* -shared-libgcc */
  /* OPT_specs = 828, */                     /* -specs */
  OPT_specs_ = 829,                          /* -specs= */
  OPT_static = 830,                          /* -static */
  OPT_static_libgcc = 831,                   /* -static-libgcc */
  OPT_static_libgfortran = 832,              /* -static-libgfortran */
  OPT_static_libgo = 833,                    /* -static-libgo */
  OPT_static_libstdc__ = 834,                /* -static-libstdc++ */
  /* OPT_std_c__03 = 835, */                 /* -std=c++03 */
  OPT_std_c__0x = 836,                       /* -std=c++0x */
  OPT_std_c__98 = 837,                       /* -std=c++98 */
  OPT_std_c1x = 838,                         /* -std=c1x */
  /* OPT_std_c89 = 839, */                   /* -std=c89 */
  OPT_std_c90 = 840,                         /* -std=c90 */
  OPT_std_c99 = 841,                         /* -std=c99 */
  /* OPT_std_c9x = 842, */                   /* -std=c9x */
  OPT_std_gnu__0x = 843,                     /* -std=gnu++0x */
  OPT_std_gnu__98 = 844,                     /* -std=gnu++98 */
  OPT_std_gnu1x = 845,                       /* -std=gnu1x */
  /* OPT_std_gnu89 = 846, */                 /* -std=gnu89 */
  OPT_std_gnu90 = 847,                       /* -std=gnu90 */
  OPT_std_gnu99 = 848,                       /* -std=gnu99 */
  /* OPT_std_gnu9x = 849, */                 /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 850, */          /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 851,              /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 852, */          /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 853, */          /* -std=iso9899:199x */
  OPT_symbolic = 854,                        /* -symbolic */
  OPT_t = 855,                               /* -t */
  OPT_time = 856,                            /* -time */
  OPT_time_ = 857,                           /* -time= */
  OPT_traditional = 858,                     /* -traditional */
  OPT_traditional_cpp = 859,                 /* -traditional-cpp */
  OPT_trigraphs = 860,                       /* -trigraphs */
  OPT_u = 861,                               /* -u */
  OPT_undef = 862,                           /* -undef */
  OPT_v = 863,                               /* -v */
  OPT_version = 864,                         /* -version */
  OPT_w = 865,                               /* -w */
  OPT_wrapper = 866,                         /* -wrapper */
  OPT_x = 867,                               /* -x */
  OPT_z = 868,                               /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
